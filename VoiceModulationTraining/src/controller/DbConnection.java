	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			Statement stmt = con.createStatement();
			 ...
			 String sql = "CREATE TABLE IF NOT EXISTS Blogs(Blog_ID varchar(25),Title varchar(100),Author varchar(50),Introduction varchar(1000),Content varchar(5000), Tags varchar(300),Views varchar(20),Cover_Pic varchar(500) , Thumbnail_Pic varchar(500) , OrderNo INT, Date_Published varchar(20), Last_Updated varchar(20));";
