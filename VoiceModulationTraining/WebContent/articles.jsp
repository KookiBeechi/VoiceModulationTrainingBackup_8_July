...
<title>Articles | Voice Modulation Training | Voice over artist | Voice coaching blogs | BharatKumar Thanvi | Voice Modulation Tips by Bharat Kumar Thanvi</title>
   ...
   <meta name="keywords" content="voicemodulationtraining , voice , voice artist, mimcry, dubbing , voice modulation training , voice modulation workshop , bharatkumar Thanvi , voice coaching , voice artist, voice artiste, Voice coaching in Mumbai , voice training in India ">
	<meta name="description" content="variuos articles / blogs on voice mdoluation tips">
					...
					<div class="col-md-12">
							...
							<h3><a href="blog-single.jsp"><%=title%></a></h3>  
								...
								<div class="blog-image">
										<img class="coverPic" src="<%=coverPic%>" alt="<%=title%>">
								</div> <!-- /.blog-image -->
