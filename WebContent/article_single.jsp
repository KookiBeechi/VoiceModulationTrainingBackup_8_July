...
<% String articleName =session.getAttribute("fullArticleName").toString();
   ...
   if ( preresult.next()) // check that the file exists
		...
		%>
<title><%=title%> | Voice Modulation Training Blogs | Voice Modulation Training with Bharat Kumar Thanvi</title>
<%}
   else{%>
   <title>Blogs | Voice Modulation Training | BharatKumar Thanvi | Voice Modulation Training with Bharat Kumar Thanvi</title>
   <%}%>

    <meta name="keywords" content="voice artist , voice artiste , Voice enhancement coaching articles , Bharat Kumar Thanvi">
...
s.src = 'https://www-voicemodulationtraining-com.disqus.com/embed.js';
...
<script id="dsq-count-scr" src="//www-voicemodulationtraining-com.disqus.com/count.js" async></script>
</body>
</html>